...
void Assets_Load(Assets *self, SDL_Renderer *renderer)
{
	...
	TextureSpec texSpecs[] = {
		{ &self->layers[0],     "../Assets/Background/game_bg.png"   },
		{ &self->layers[1],     "../Assets/Background/game_bg.png"   },
	...
	{ &self->boss, "../Assets/Enemy/boss_2.png"},
	{ &self->superBoss, "../Assets/Enemy/boss_3.png"},
	{ &self->fighterAttack2, "../Assets/Enemy/missile.png"},
	{ &self->fighter2, "../Assets/Enemy/boss_2.png"},
	{ &self->fighterSpecial, "../Assets/Enemy/fire_tornado.png"}
	};
